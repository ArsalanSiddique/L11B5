                            ...
                            <div class="row g-0 h-100">
                                <div class="col-md-5 text-center bg-card-gradient">
                                    <div class="position-relative p-4 pt-md-5 pb-md-7 light">
                                        ...
                                        <div class="z-index-1 position-relative"><a class="link-light mb-4 font-sans-serif fs-4 d-inline-block fw-bolder" href="{{ url('/') }}">{{ env('APP_NAME') }}</a>
                                            <p class="opacity-75 text-white">{{ __('With the power of Falcon, you can now focus only on functionaries for your digital products, while leaving the UI design on us!') }}</p>
                                        </div>
                                    </div>
                                    @if (Route::has('register'))
                                    <div class="mt-3 mb-4 mt-md-4 mb-md-5 light">
                                        <p class="text-white">{{ __('Don\'t have an account?') }}<br><a class="text-decoration-underline link-light" href="../../../pages/authentication/card/register.html">{{ __('Get started!') }}</a></p>
                                        <p class="mb-0 mt-4 mt-md-5 fs--1 fw-semi-bold text-white opacity-75">{{ __('Read our') }} <a class="text-decoration-underline text-white" href="#!">terms</a> and <a class="text-decoration-underline text-white" href="#!">{{ __('conditions') }} </a></p>
                                    </div>
                                    @endif
                                </div>
